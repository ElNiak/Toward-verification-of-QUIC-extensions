cd /home/chris/TVOQE_16/quic/ #TODO

#Install depot_tools
[ ! -f depot_tools/ ] && git clone https://chromium.googlesource.com/chromium/tools/depot_tools.git
export PATH="$PATH:/home/chris/TVOQE_16/quic/depot_tools" #TODO
echo export PATH="$PATH:/home/chris/TVOQE_16/quic/depot_tools" >> ~/.profile 
